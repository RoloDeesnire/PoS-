...
namespace POSales
{
    public partial class Cashier : Form
    {
        ...
        {
            slide(btnSettle);
            payment settle = new payment(this);
        ...
        private void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please cancel all transaction before logging out.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        public void LoadCart()
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    dgvCash.Rows.Add(i, dr["id"].ToString(), dr["pcode"].ToString(), dr["pdesc"].ToString(), dr["price"].ToString(), dr["qty"].ToString(), double.Parse(dr["total"].ToString()).ToString("#,##0.00"));
                    hascart = true;
                }
                dr.Close();
                cn.Close();
